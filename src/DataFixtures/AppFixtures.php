...
class AppFixtures extends Fixture
{
    ...
    {
        foreach ($this->getFigureData() as [$title, $slug, $summary, $content, $published_at, $author, $tags]) {
            ...
            $figure->setPublishedAt($published_at);
    ...
    private function getFigureData()
    {

        $figures = [];
        foreach ($this->getPhrases() as $i => $title) {

                    // $figureData = [$title, $slug, $summary, $content, $category, $style, $publishedAt, $author, $tags, $comments];
            $figures[] = [
                $title,
                Slugger::slugify($title),
                $this->getRandomText(),
                $this->getFigureContent(),
                new DateTime('now - '.$i.'days'),
                // Ensure that the first Figure is written by Jane Doe to simplify tests
    ...
    private function getFigureContent(): string
    {
        return <<<'MARKDOWN'
